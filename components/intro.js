          ...
          <div className="pt-8 md:p-8 text-center md:text-left space-y-4 text-lg text-white font-medium">
            <blockquote>
              ...
              <div className='container w-auto'>
                <p className=''>Software developer with {new Date().getFullYear() - 2018} years of experience able to bring expertise in <br /> design, installation, testing and maintenance of software systems.</p>
              </div>
